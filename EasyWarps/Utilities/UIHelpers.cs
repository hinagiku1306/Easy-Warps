...
namespace EasyWarps
{
    public static class UIHelpers
    {
        ...
        {
            return anchorBottom + panelPaddingV + DropdownArrowPad - DropdownArrowNudge + 4 - arrowYNudge;
        }
        ...
        internal static int CalculateDropdownDownArrowY(int anchorBottom, int dropdownHeight, int panelPaddingV = 0, int arrowYNudge = 0)
        {
            ...
            return anchorBottom + panelPaddingV + dropdownHeight - arrowH - DropdownArrowPad + DropdownArrowNudge - 4 + arrowYNudge;
        }
